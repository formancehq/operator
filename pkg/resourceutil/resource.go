...
func CreateOrUpdateWithOwner[T client.Object](ctx context.Context, client client.Client, scheme *runtime.Scheme,
	...
	operationResult, err := controllerutil.CreateOrUpdate(ctx, client, ret, func() error {
		...
		if !metav1.IsControlledBy(ret, owner) {
			return controllerutil.SetOwnerReference(owner, ret, scheme)
		}
		return nil
	})
