...
func (spec *AuthConfigSpec) Env(prefix string) []corev1.EnvVar {
	...
	if spec.OAuth2 != nil {
		ret = append(ret, v1beta1.EnvWithPrefix(prefix, "AUTH_BEARER_ENABLED", "true"))
		ret = append(ret, v1beta1.EnvWithPrefix(prefix, "AUTH_BEARER_INTROSPECT_URL", spec.OAuth2.IntrospectUrl))
		if spec.OAuth2.AudienceWildcard {
			ret = append(ret, v1beta1.EnvWithPrefix(prefix, "AUTH_BEARER_AUDIENCES_WILDCARD", "true"))
		} else {
			ret = append(ret, v1beta1.EnvWithPrefix(prefix, "AUTH_BEARER_AUDIENCE", strings.Join(spec.OAuth2.Audiences, " ")))
		}
		if spec.OAuth2.ProtectedByScopes {
			ret = append(ret, v1beta1.EnvWithPrefix(prefix, "AUTH_BEARER_USE_SCOPES", "true"))
		}
	}
	if spec.HTTPBasic != nil && spec.HTTPBasic.Enabled {
		...
		ret = append(ret, v1beta1.EnvWithPrefix(prefix, "AUTH_BASIC_ENABLED", "true"))
		ret = append(ret, v1beta1.EnvWithPrefix(prefix, "AUTH_BASIC_CREDENTIALS", credentials))
	}
	return ret
}
