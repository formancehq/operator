...
type PostgresConfig struct {
	...
	Port int `json:"port"`
	// +optional
	PortFrom *v1beta1.ConfigSource `json:"portFrom"`
	// +optional
	Host string `json:"host"`
	// +optional
	HostFrom *v1beta1.ConfigSource `json:"hostFrom"`
	// +optional
	Username string `json:"username"`
	// +optional
	UsernameFrom *v1beta1.ConfigSource `json:"usernameFrom"`
	// +optional
	Password string `json:"password"`
	// +optional
	PasswordFrom *v1beta1.ConfigSource `json:"passwordFrom"`
}
...
type PostgresConfigWithDatabase struct {
	...
	// +optional
	DatabaseFrom *v1beta1.ConfigSource `json:"databaseFrom"`
}
