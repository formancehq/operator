...
func envVars(webhooks *componentsv1beta2.Webhooks) []corev1.EnvVar {
	...
	env = append(env,
		apisv1beta2.Env("STORAGE_MONGO_CONN_STRING", "$(MONGODB_URI)"),
		apisv1beta2.Env("STORAGE_MONGO_DATABASE_NAME", "$(MONGODB_DATABASE)"),
			...
			Template: corev1.PodTemplateSpec{
				...
				Spec: corev1.PodSpec{
					...
					Containers: []corev1.Container{{
						Name:            "webhooks",
						Image:           webhooks.GetImage(),
						ImagePullPolicy: controllerutils.ImagePullPolicy(webhooks),
