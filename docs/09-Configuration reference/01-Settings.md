...
| transaction-plane.worker-enabled                                                         | bool   | false                                                                                                                                                                                                                   | Enable the embedded worker inside the transaction-plane server to run a single service instead of separate API and worker processes                                                                                              |
