...
| transactions.worker-enabled                                                              | bool   | true                                                                                                                                                                                                                   | Enable the embedded worker inside the transactions server to run a single service instead of separate API and worker processes                                                                                                   |
