...
| transactions.worker-enabled                                                              | bool   | false                                                                                                                                                                                                                   | Enable the embedded worker inside the transactions server to run a single service instead of separate API and worker processes                                                                                                   |
