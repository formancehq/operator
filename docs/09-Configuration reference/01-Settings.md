...
| payments.cleanup-temporal                                                                | bool   | true                                                                                                                                                                                                                   | Whether to clean up Temporal workflows when the Payments module is deleted (default: true). Set to `false` to skip the cleanup, e.g. when migrating a stack across clusters.                                                     |
