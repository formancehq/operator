...
| ledger.schema-enforcement-mode                                                           | String | strict                                                                                                                                                                                                                 | Schema enforcement mode for the Ledger (v2.3+)                                                                                                                                                                                   |
...
| ledger.worker.bucket-cleanup                                                             | Map    | retention-period=720h, schedule="0 0 * * *"                                                                                                                                                                            | Configure bucket cleanup for the Ledger worker (v2.3+). Fields: `retention-period`, `schedule`                                                                                                                                   |
