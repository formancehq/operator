...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OtelAuthConfig) DeepCopyInto(out *OtelAuthConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OtelAuthConfig.
func (in *OtelAuthConfig) DeepCopy() *OtelAuthConfig {
	if in == nil {
		return nil
	}
	out := new(OtelAuthConfig)
	in.DeepCopyInto(out)
	return out
}
